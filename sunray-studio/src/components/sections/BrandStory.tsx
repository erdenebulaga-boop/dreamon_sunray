...
export function BrandStory() {
  return (
    <section className="bg-[#111827] relative overflow-hidden py-20 md:py-25">
      {/* Subtle warm accent */}
        ...
        <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2 md:gap-16">
          ...
          <FadeIn direction="right" delay={0.2}>
            <div>
              ...
              <h2 className="mt-4 font-display text-3xl font-semibold text-gray-100 md:text-4xl lg:text-5xl">
